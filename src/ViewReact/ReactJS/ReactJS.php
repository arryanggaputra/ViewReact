...
namespace Arryanggaputra\ReactJS;
...
class ReactJS
{
     ...
     * @param string $appsrc Application source code || We dont need this
     */
    public function __construct($libsrc)
    {
        $react = array();
        // stubs, react
        ...
        // app's components
        // On JSX, webpack will rendering all dependency, so just comment this line
        // $react[] = $appsrc;
        $react[] = ';';
     ...
     */
    public function setComponent($component, $data = null)
    {
     ...
     */
    public function getJS($where, $return_var = null)
    {
